...
def four_combo(N=8000, x0=0.0, delta=0.4, kmax=6, seed=0):
    ...
    fig.tight_layout(); fig.savefig("fig_mixedmode.pdf"); print("\nfigure written: fig_mixedmode.pdf")
    return rows
...
def superpose_showcase(seed=7, N=8000, path=None):
    ...
    fig.tight_layout()
    out = path or "fig_superpose.pdf"; fig.savefig(out, bbox_inches='tight'); plt.close(fig)
    return out
...
def alternating_showcase(N=8000, kmax=6, seed=0):
    ...
    fig.tight_layout(); fig.savefig("fig_alternating.pdf"); print("figure written: fig_alternating.pdf")
...
def fidelity_sweep(targets=("kurtotic", "halfhalf"), N=8000, eps_list=(0.0, 0.05, 0.10, 0.20, 0.40),
    ...
    fig.tight_layout(); fig.savefig("fig_datagen_sweep.pdf"); print("\nfigure written: fig_datagen_sweep.pdf")
    return results
...
def halfhalf_figure(N=8000, kmax=6, seed=0):
    ...
    fig.tight_layout(); fig.savefig("fig_datagen.pdf"); print("\nfigure written: fig_datagen.pdf")
